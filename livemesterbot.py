...
@app.route('/')
def home():
    return "A LiveMesterBot fut és figyeli a meccseket!"
...
# A Render felületén az 'Environment Variables' fül alatt add meg ezeket!
API_KEY = os.environ.get("FOOTBALL_API_KEY", "IDE_IRD_AZ_API_KULCSOT_HA_NEM_HASZNALZ_ENV_VAR-T")
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "IDE_IRD_A_TG_TOKENT_HA_NEM_HASZNALZ_ENV_VAR-T")
CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID", "IDE_IRD_A_CHAT_ID-T_HA_NEM_HASZNALZ_ENV_VAR-T")
...
def main_loop():
    sent_ids = set()
    print(f"[{datetime.now()}] Bot motor indul...")
    ...
    while True:
        ...
        time.sleep(30) # 30 másodperces frissítés
